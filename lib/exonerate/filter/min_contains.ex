...
#
  ...
  defmacro postprocess(contains, acc, list, path) do
    quote do
      unless unquote(acc).contains < unquote(contains), do: Exonerate.mismatch(unquote(list), unquote(path), guard: "minItems")
    end
  end
end
