defmodule ExonerateTest.Parse.NumberTest do
  ...
  describe "multipleOf parameters is not set" do
    test "correctly" do
      assert %{
               filters: [%MultipleOf{}]
             } = Number.parse(@context, %{"multipleOf" => 3})
    end
  end
end
